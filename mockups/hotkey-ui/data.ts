// Fake window list for the picker mockup — mirrors `stage-studio list-windows` output shape.
...
export const MOCK_WINDOWS: MockWindow[] = [
  ...
  { windowId: 8455, app: "cmux", title: "stage-studio · project-lead", glyph: "⌘", from: "#2a2d34", to: "#101114" },
