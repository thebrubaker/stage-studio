// windowclip input recorder — taps mouse-down + mouseMoved + drag events and emits JSONL to stdout.
//
...
guard let tap = CGEvent.tapCreate(
    ...
    FileHandle.standardError.write(Data("windowclip: failed to create event tap — grant Accessibility permission in System Settings\n".utf8))
    exit(1)
}
...
FileHandle.standardError.write(Data("windowclip-input: ready\n".utf8))
